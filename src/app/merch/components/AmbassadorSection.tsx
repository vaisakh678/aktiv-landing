...
const AmbassadorSection = () => {
  return (
    <section className="relative mb-[79px]">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-[#3399FF] to-[#00E676] p-6 md:p-11">
        ...
        <button
          className="mt-7 h-[52px] w-full rounded-xl bg-gradient-to-r from-[#3399FF] to-[#00E676] text-center font-poppins text-xl font-medium hover:opacity-80 md:max-w-[414px]"
          style={{
